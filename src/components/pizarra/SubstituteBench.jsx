    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="truncate font-semibold text-text-primary">
          ...
          <span className="text-accent">#{player.number}</span> {getFullName(player)}
...
export default function SubstituteBench({
  ...
  return (
    ...
    <div
      ...
      className="rounded-2xl border border-dashed border-slate-300/80 bg-gradient-to-b from-slate-50/90 to-white p-4 shadow-sm transition hover:border-accent/40"
